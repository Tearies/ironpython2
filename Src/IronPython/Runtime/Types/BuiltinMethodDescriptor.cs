...
namespace IronPython.Runtime.Types {
    ...
    public sealed class BuiltinMethodDescriptor : PythonTypeSlot, IDynamicMetaObjectProvider, ICodeFormattable {
        ...
        public int __cmp__(object other) {
            BuiltinMethodDescriptor bmd = other as BuiltinMethodDescriptor;
            if (bmd == null) {
                throw PythonOps.TypeError(ResourceManager.Default.GetResource("instancemethodcmpxyrequiresytobeainstancemethodnota0", "instancemethod.__cmp__(x,y) requires y to be a 'instancemethod', not a {0}"), PythonTypeOps.GetName(other));
            }
